...
#
# Table structure for table 'tx_contributorycalculator_domain_model_search'
#
CREATE TABLE tx_contributorycalculator_domain_model_search (

	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,

	child_age int(11) DEFAULT '0' NOT NULL,
	hours_of_childcare int(11) DEFAULT '0' NOT NULL,
	chargeable_income int(11) DEFAULT '0' NOT NULL,
